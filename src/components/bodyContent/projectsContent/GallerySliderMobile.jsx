                ...
                {data[value].map((content, index) => (
                    <SwiperSlide>
                        ...
                        <div className="gallery-mobile-top">
                            ...
                            <div className="gallery-mobile-bottom"><GiBranchArrow style={{rotate: '135deg', marginLeft: '5px'}} className="gallery-arrow swiper-button-prev"/>
                                {content.video !== false && <button onClick={() => displayPopUp(content.video, content.image)} className="work_link-mobile">view video</button>}
                                <GiBranchArrow style={{rotate: '-45deg', marginRight: '5px'}} className="gallery-arrow swiper-button-next"/>
                            </div>
                        </div>
                    </SwiperSlide> 
                ))}
