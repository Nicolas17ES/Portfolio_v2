...
function ScreenOverlay() {
    ...
    const { display_vide_popup } = useContext(GlobalContext);



//   useGSAP(() => {
//     if(display_vide_popup.value){
//         gsap.to('.screen-overlay-container', {
//             opacity: 1,
//             duration: 1,
//             ease: 'Expo.easeInOut',
//         })
//     } else if (!display_vide_popup.value) {
//         gsap.to('.screen-overlay-container', {
//             opacity: 0,
//             duration: 1,
//             ease: 'Expo.easeInOut',
//         })
//     }
//   }, [display_vide_popup.value]);
    
// console.log("display_vide_popup", display_vide_popup.value)
